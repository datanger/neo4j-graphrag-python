...
async def test_pure_python_demo():
    """演示纯Python实现的MATLAB代码提取器"""
    print("=== 演示纯Python实现的MATLAB代码提取器 ===")
    
    # 创建测试目录和文件
    test_dir = Path("test_pure_python_demo")
...
if __name__ == "__main__":
    asyncio.run(test_pure_python_demo())
